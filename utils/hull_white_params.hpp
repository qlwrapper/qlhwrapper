...
namespace utils {
    ...
    struct LogNormalVolTraits {
        ...
        static std::function<T(T)> f() { return &log_r; }
        static std::function<T(T)> f_inv() { return &exp_r; }
    };
    ...
    struct NormalVolTraits {
        ...
        static std::function<T(T)> f() { return &identity_r; }
        static std::function<T(T)> f_inv() { return &identity_r; }
    };
